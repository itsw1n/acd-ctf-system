      ...
      <TacticalPanel label="Solve history" className="p-5 sm:p-7">
        <div className="mb-6 grid gap-3 sm:grid-cols-2 lg:ml-auto lg:max-w-xl">
          <div className="flex items-center gap-4 border border-border-strong bg-background/75 p-4">
            ...
            <div>
              <div className="font-mono text-[10px] uppercase tracking-[0.13em] text-muted">Total solves</div>
          ...
          <div className="flex items-center gap-4 border border-danger/45 bg-primary/5 p-4">
            ...
            <div>
              <div className="font-mono text-[10px] uppercase tracking-[0.13em] text-muted">Total points</div>
              <div className="font-mono text-2xl font-bold text-danger-bright">{totalPoints} PTS</div>
            </div>
          </div>
        </div>
            ...
            <tbody>
              {activity.map((row) => (
                <tr key={row.id} className="border-b border-border/70 text-xs text-foreground">
                  <td className="px-4 py-4 text-muted">{new Date(row.solvedAt).toLocaleString()}</td>
                  ...
                  <td className="px-4 py-4 text-right font-bold text-danger-bright">+{row.points}</td>
                </tr>
              ))}
            </tbody>
          </table>
